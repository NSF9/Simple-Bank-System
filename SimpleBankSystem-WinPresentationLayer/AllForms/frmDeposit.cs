...
namespace SimpleBankSystem_WinPresentationLayer
{
    ...
    {
        clsClients _Client;
        public frmDeposit(clsClients Client,int _SelectedClientID)
        {
            InitializeComponent();
        ...
        {
            clsButtonStyler.ButtonADUStyler(btnDepsite);
        ...
        {
            DepositPanel.BorderRadius = 1;
            DepositPanel.FillColor = Color.DarkGray;
            DepositPanel.BorderColor = Color.FromArgb(220, 220, 220);
            DepositPanel.BorderThickness = 1;


            DepositPanel.ShadowDecoration.Enabled = true;
            DepositPanel.ShadowDecoration.Color = Color.Gray;
            DepositPanel.ShadowDecoration.Depth = 10;
            DepositPanel.ShadowDecoration.Shadow = new Padding(5);
        ...
        private void btnDepsite_Click(object sender, EventArgs e)
        {
            bool result = Deposit();
